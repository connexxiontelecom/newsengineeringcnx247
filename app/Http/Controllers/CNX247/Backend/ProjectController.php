...
class ProjectController extends Controller
{
	...
	*/
	public function projectBoard(){
		$this->applog->setNewLog(Auth::user()->tenant_id, Auth::user()->id, Auth::user()->first_name.' accessed project board.');
	...
	*/
	public function newProject(){
		...
		$this->applog->setNewLog(Auth::user()->tenant_id, Auth::user()->id, Auth::user()->first_name.' launched create project form.');
	...
	*/
	public function storeProject(Request $request){
		...
		$message = Auth::user()->first_name.' created a new project titled '.$request->project_name.' with the ID '.$project_id;
	...
	*/
	...
	public function projectBudget($url){
		...
		if(!empty($project)){
			...
			$message = Auth::user()->first_name.' viewed '.$project->post_title.'('. $project->id.') project budget.';
	...
	public function storeProjectBudget(Request $request){
		...
		$budget->save();
		$message = Auth::user()->first_name.' created a new budget for project ID: '.$request->projectId;
		$this->applog->setNewLog(Auth::user()->tenant_id, Auth::user()->id, $message);
	...
	*/
	public function projectCalendar(){
		$this->applog->setNewLog(Auth::user()->tenant_id, Auth::user()->id, Auth::user()->first_name.' accessed project calendar.');
	...
	*/
	public function projectGanttChart(){
		$this->applog->setNewLog(Auth::user()->tenant_id, Auth::user()->id, Auth::user()->first_name.' accessed project gantt chart.');
	...
	*/
	public function projectAnalytics(){
		$this->applog->setNewLog(Auth::user()->tenant_id, Auth::user()->id, Auth::user()->first_name.' accessed project analytics.');
...
*/
	public function updateProject(Request $request){
		...
		$project->tenant_id = Auth::user()->tenant_id;
		$project->save();
		$message = Auth::user()->first_name.' made changes to project with ID: '.$project->id;
		$this->applog->setNewLog(Auth::user()->tenant_id, Auth::user()->id, $message);
	...
	public function deleteProject(Request $request){
		...
		$activity = Auth::user()->first_name.' deleted project with the ID: '.$request->projectId;
		$this->applog->setNewLog(Auth::user()->tenant_id, Auth::user()->id, $activity);
	...
	public function addResponsiblePerson(Request $request)
	{
		...
		$activity = Auth::user()->first_name.' added a new person to project - '.$task->post_title.' : '.$task->id;
		$this->applog->setNewLog(Auth::user()->tenant_id, Auth::user()->id, $activity);
