																								...
																								<div class="row timeline-right p-t-35">
																										...
																										<div class="col-10 col-sm-10 col-xl-11 p-l-5 p-b-35">
																												<div class="card">
																														...
																														<div class="card-block b-b-theme b-t-theme social-msg">
																																@if(!empty($post->postLikes()->where('user_id', Auth::user()->id)->first()))
																																		<a href="javascript:void(0);" onclick="unlikePost({{ $post->id }})"> <i class="icofont icofont-thumbs-down text-danger" ></i>
																																				<span class="b-r-muted">Unlike ({{ count($post->postLikes) }}) </span>
																																		</a>

																																@elseif(empty($post->postLikes()->where('user_id', Auth::user()->id)->first()))
																																		<a href="javascript:void(0);" onclick="likePost({{ $post->id }})"> <i class="icofont icofont-like text-success" ></i>
																																				<span class="b-r-muted">Like ({{ count($post->postLikes) }}) </span>
																																		</a>
																																@endif
																																...
																																<div class="media">
																																		...
																																		<div class="media-body">
																																				...
																																				<div class="commentWrapper">
																																						<textarea  rows="5" cols="5" class="form-control commentControl" placeholder="Leave comment"></textarea>

																																						<div class="text-right m-t-20">
																																								<button class="btn btn-out-dashed btn-primary btn-square btn-sm " type="button" onclick="leaveComment({{ $post->id }})">Comment</button>
																																						</div>
																																				</div>
																																		</div>
																																</div>
																						...
																						<div class="row timeline-right p-t-35">
																								...
																								<div class="col-10 col-sm-10 col-xl-11 p-l-5 p-b-35">
																										<div class="card">
																												...
																												<div class="card-block b-b-theme b-t-theme social-msg">
																														@if(!empty($post->postLikes()->where('user_id', Auth::user()->id)->first()))
																																<a href="javascript:void(0);" onclick="unLike({{ $post->id }})"> <i class="icofont icofont-thumbs-down text-danger" ></i>
																																		<span class="b-r-muted">Unlike ({{ count($post->postLikes) }}) </span>
																																</a>
																						...
																						<div class="row timeline-right p-t-35">
																								...
																								<div class="col-10 col-sm-10 col-xl-11 p-l-5 p-b-35">
																										<div class="card">
																												...
																												<div class="card-block b-b-theme b-t-theme social-msg">
																														@if(!empty($post->postLikes()->where('user_id', Auth::user()->id)->first()))
																																<a href="#" onclick="unlikePost({{ $post->id }})"> <i class="icofont icofont-thumbs-down text-danger" ></i>
																																		<span class="b-r-muted">Unlike ({{ count($post->postLikes) }}) </span>
																																</a>
