                        ...
                        <div class="row">
                            @foreach ($myFiles as $file)
                                @switch(pathinfo($file->filename, PATHINFO_EXTENSION))
                                    @case('pptx')
                                    <div class="col-md-1">
                                        <a href="/assets/uploads/cnxdrive/{{$file->filename}}" target="_blank" data-toggle="tooltip" data-placement="top" title="{{$file->name ?? 'No name'}}" data-original-title="{{$file->name ?? 'No name'}}" style="cursor: pointer;">
                                    ...
                                    @case('csv')
                                    <div class="col-md-1">
                                        <a href="/assets/uploads/cnxdrive/{{$file->filename}}" target="_blank" style="cursor: pointer;"  data-toggle="tooltip" data-placement="top" title="{{$file->name ?? 'No name'}}" data-original-title="{{$file->name ?? 'No name'}}">
