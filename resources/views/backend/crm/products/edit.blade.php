                        ...
                        <div class="row">
                            <div class="col-md-8">
                               <div class="form-group">
                                   ...
                                   <input type="text" name="product_name" placeholder="Product Name" class="form-control" value="{{old('product_name', $product->product_name)}}">
                                   @error('product_name')
                               ...
                               <div class="form-group">
                                   ...
                                   <textarea name="product_description" class="form-control content" placeholder="Product Description">{{old('product_description', $product->product_description)}}</textarea>
                               ...
                               <div class="form-group">
                                   ...
                                   <input type="number" placeholder="Price" name="price" class="form-control" value="{{old('price', $product->price)}}">
                                   @error('price')
                                       <i class="text-danger mt-2">{{$message}}</i>
                                   @enderror
                               </div>
