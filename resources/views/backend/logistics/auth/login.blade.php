            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-5 col-md-6">
                    <div class="card login-page bg-white shadow rounded border-0">
                        <div class="card-body">
                            <h4 class="card-title text-center">Logistics - Login</h4>
                            ...
                            <div class="alert alert-warning border-warning">
                                ...
                                @endif
                            <form class="login-form mt-4" action="{{route('logistics.login')}}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group position-relative">
                                            ...
                                            <input type="email" name="email" class="form-control pl-5" placeholder="Email">
                                            @error('email')
                                                <span class="mt-3">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group position-relative">
                                            ...
                                            <input type="password" name="password" class="form-control pl-5" placeholder="Password">
                                        </div>
                                    </div>
