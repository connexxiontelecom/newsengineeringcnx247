...
{{--        </div>--}}
    ...
    <div class="nav-item nav-grid">
        <a href="{{route('logistics-drivers')}}" class="btn btn-warning btn-mini waves-effect waves-light"><i class="icofont icofont-tasks mr-2"></i>All Drivers</a>
        <a href="{{route('new-driver')}}" class="btn btn-primary btn-mini waves-effect waves-light"><i class="ti-plus mr-2"></i>Add New Driver</a>
    </div>
</nav>
