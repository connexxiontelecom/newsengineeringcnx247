                ...
                <form method="post" action="{{route('update-task')}}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" id="start_date" placeholder="dd/mm/yyyy" name="start_date" value="{{old('start_date', date(Auth::user()->tenant->dateFormat->format ?? 'd/M/Y', strtotime($task->start_date)))}}" class="form-control form-control-normal" >
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" id="due_date" name="due_date" value="{{old('due_date', $task->end_date)}}" class="form-control form-control-normal" placeholder="dd/mm/yyyy">
