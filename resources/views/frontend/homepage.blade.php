         ...
         <nav class="navbar navbar-expand-lg navbar-light navbar-default navbar-fixed-top" role="navigation">
            <div class="container">
                <a class="navbar-brand page-scroll" href="#main">
                    <img class="img-fluid ml-5 " src="/assets/images/logo.png" alt="CNX247 ERP Solution" height="52" width="82">
                </a>
    ...
    <div class="main" id="main">
            ...
            <div class="container">
                <div class="hero-content app-hero-content text-center">
                    <div class="row justify-content-md-center">
                        <div class="col-md-10">
                            <h1 class="wow fadeInUp" data-wow-delay="0s">Africa's First ERP Solution</h1>
                            <p class="wow fadeInUp" data-wow-delay="0.2s">
                                CNX247 is an Enterprise Resource Planning Solution designed to suit<br class="hidden-xs">  the African workplace and beyond.
                            </p>
                            <a class="btn btn-primary btn-action" href="#learn-more" data-wow-delay="0.2s" href="#">Learn More</a>
                            <a class="btn btn-primary btn-action" href="#pricing" data-wow-delay="0.2s" href="#">Pricing</a>
                        </div>
                        <div class="col-md-12">
                            <div class="hero-image">
                                <img class="img-fluid" src="/assets/front/images/app_hero_1.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.2s">
                                    <div class="services-icon">
                                        <img src="/assets/front/logos/icon1.png" height="60" width="60" alt="Service">
                                    </div>
                                ...
                                <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.3s">
                                    <div class="services-icon">
                                        <img class="icon-2" src="/assets/front/logos/icon2.png" height="60" width="60" alt="Service">
                                    </div>
                                    <div class="services-description">
                                ...
                                <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.4s">
                                    <div class="services-icon">
                                        <img class="icon-3" src="/assets/front/logos/icon3.png" height="60" width="60" alt="Service">
                                    </div>
                                    <div class="services-description">
                ...
                <div class="flex-split">
                    <div class="f-left wow fadeInUp" data-wow-delay="0s">
                        <div class="left-content">
                            <img class="img-fluid" src="/assets/front/images/feature_1.png" alt="">
                        </div>
                    </div>
                ...
                <div class="flex-split">
                    ...
                    <div class="f-left">
                        <div class="left-content wow fadeInUp" data-wow-delay="0.3s">
                            <img class="img-fluid" src="/assets/front/images/feature_2.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row text-center">
                    <div class="col-md-12">
                        <div class="testimonials owl-carousel owl-theme">
                            <div class="testimonial-single"><img class="img-circle" src="/assets/front/images/testimonial2.jpg" alt="Client Testimonoal">
                            ...
                            <div class="testimonial-single"><img class="img-circle" src="/assets/front/images/testimonial1.jpg" alt="Client Testimonoal">
                            ...
                            <div class="testimonial-single"><img class="img-circle" src="/assets/front/images/testimonial3.jpg" alt="Client Testimonoal">
                                <div class="testimonial-text">
        ...
        <div class="feature_huge text-center">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <img class="img-fluid wow fadeInUp" data-wow-delay="0.1s" src="/assets/front/images/big_feature.png" alt="" style="max-width:100%">
                    </div>
                    <div class="col-md-12 feature_list">
                        <div class="row">
                            <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.2s">
                                <img src="/assets/front/logos/feature_icon.png" alt="Feature">
                            ...
                            <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.4s">
                                <img src="/assets/front/logos/feature_icon_2.png" alt="Feature">
                            ...
                            <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.6s">
                                <img src="/assets/front/logos/feature_icon_3.png" alt="Feature">
                            ...
                            @if (count($plans) > 0)
                                ...
                                <div class="col-sm-6">
                                    <div class="table-left wow fadeInUp" data-wow-delay="0.4s">
                                        <div class="icon">
                                            <img src="/assets/front/logos/cart2.png" alt="Icon">
                                        </div>
                                            ...
                                            <div class="pricing-details">
                                                ...
                                                <a href="{{route('create-site', ['timestamp'=>sha1(time()),'plan'=>$plan->slug] )}}" class="btn btn-primary btn-action btn-fill">Get Plan</a>
                                            </div>
                                    </div>
                                </div>
                                @endforeach
        ...
        <div class="client-section">
            <div class="container text-center">
                <div class="clients owl-carousel owl-theme">
                    <div class="single">
                        <img src="/assets/front/logos/logo1.png" alt="">
                    </div>
                    <div class="single">
                        <img src="/assets/front/logos/logo2.png" alt="">
                    </div>
                    <div class="single">
                        <img src="/assets/front/logos/logo3.png" alt="">
                    </div>
                    <div class="single">
                        <img src="/assets/front/logos/logo4.png" alt="">
                    </div>
                    <div class="single">
                        <img src="/assets/front/logos/logo6.png" alt="">
                    </div>
                    <div class="single">
                        <img src="/assets/front/logos/logo7.png" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cta-sub text-center no-color">
            <div class="container">
                ...
                <div class="form wow fadeInUp" data-wow-delay="0.3s">
                    <form class="subscribe-form wow zoomIn" action="/assets/front/php/subscribe.php" method="post" accept-charset="UTF-8" enctype="application/x-www-form-urlencoded" autocomplete="off" novalidate="">
        ...
        <div class="footer">
            <div class="container">
                <div class="col-md-12 text-center">
                    <img src="/assets/front/logos/logo.png" alt="Adminty Logo">
