                ...
                <div class="card-block">
                    <div class="row align-items-center m-l-0">
                        ...
                        <div class="col-auto">
                            ...
                            <h5 class="m-b-0">{{number_format($projects->where('post_status', 'at-risk')->where('tenant_id', Auth::user()->tenant_id)->where('post_type', 'project')->count())}}</h5>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-block">
                    <div class="row align-items-center m-l-0">
                        ...
                        <div class="col-auto">
                            ...
                            <h5 class="m-b-0">{{number_format($projects->where('post_status', 'in-progress')->where('tenant_id', Auth::user()->tenant_id)->where('post_type', 'project')->count())}}</h5>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-block">
                    <div class="row align-items-center m-l-0">
                        ...
                        <div class="col-auto">
                            ...
                            <h5 class="m-b-0">{{number_format($projects->where('post_status', 'completed')->where('tenant_id', Auth::user()->tenant_id)->where('post_type', 'project')->count())}}</h5>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-block">
                    <div class="row align-items-center m-l-0">
                        ...
                        <div class="col-auto">
                            ...
                            <h5 class="m-b-0">{{number_format($projects->where('post_status', 'cancelled')->where('tenant_id', Auth::user()->tenant_id)->where('post_type', 'project')->count())}}</h5>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xl-3 col-md-12">
                    <div class="card user-card2">
                        <div class="card-block text-center">
                            ...
                            <div class="risk-rate">
                                <span>{{number_format($projects->where('post_status', 'completed')->where('tenant_id', Auth::user()->tenant_id)->where('post_type', 'project')->count() - $projects->where('post_status', 'in-progress')->where('tenant_id', Auth::user()->tenant_id)->where('post_type', 'project')->count())}}</span>
                            </div>
                            <h6 class="m-b-10 m-t-10">Scale</h6>
                            <a href="{{route('project-board')}}" class="text-c-yellow b-b-warning">Project Dashboard</a>
                            <div class="row justify-content-center m-t-10 b-t-default m-l-0 m-r-0">
                                <div class="col m-t-15 b-r-default">
                                    <h6 class="text-muted">Completed</h6>
                                    <h6>{{number_format($projects->where('post_status', 'completed')->where('tenant_id', Auth::user()->tenant_id)->where('post_type', 'project')->count())}}</h6>
                                </div>
                                <div class="col m-t-15">
                                    <h6 class="text-muted">In-progress</h6>
                                    <h6>{{number_format($projects->where('post_status', 'in-progress')->where('tenant_id', Auth::user()->tenant_id)->where('post_type', 'project')->count())}}</h6>
                                </div>
                            </div>
                        </div>
                    </div>
