                  ...
                  <tr>
                    <td class="content-cell" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px; padding: 35px;">
                      <div class="f-fallback">
                        <h1 style="margin-top: 0; color: #333333; font-size: 22px; font-weight: bold; text-align: left;" align="left">Hi, {{$client->first_name ?? ''}}!</h1>
                        <p style="font-size: 16px; line-height: 1.625; color: #333; margin: .4em 0 1.1875em;">
                            {!! $message->content !!}
                        </p>

                        <p style="font-size: 16px; line-height: 1.625; color: #333; margin: .4em 0 1.1875em;">If you have any questions, feel free to <a href="mailto:{{Auth::user()->tenant->email ?? 'info@cnx247.com'}}" style="color: #3869D4;">email our customer success team</a>.</p>
                        <p style="font-size: 16px; line-height: 1.625; color: #333; margin: .4em 0 1.1875em;">Thanks,
                          <br />{{Auth::user()->tenant->company_name ?? 'CNX247'}} <br>
                        </p>
                      </div>
                    </td>
                  </tr>
